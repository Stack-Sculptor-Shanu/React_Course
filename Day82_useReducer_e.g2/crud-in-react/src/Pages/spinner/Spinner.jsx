	...
	<g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-width="2" transform="translate(0,19)">
		<g className="pl__layer">
			<g className="pl__scene">
				<path className="pl__curve" d="M 16 9 C 16 4.582 19.582 1 24 1 C 28.418 1 32 4.582 32 9" stroke-dasharray="25.13 25.13" stroke-dashoffset="25.12" />
				<polyline className="pl__dot" points="32 9,48 9" stroke-dasharray="0.01 16" />
			</g>
		</g>
